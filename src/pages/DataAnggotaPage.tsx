...
import { Search, Filter, Plus, Eye, Trash2, Upload, X } from "lucide-react";
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-[#BE4139]">
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            disabled={uploading}
            className="gap-2 text-white bg-green-600 hover:bg-green-700 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
            <Upload size={18} />
          ...
          <Button
            ...
            className="gap-2 text-white bg-[#BE4139] hover:bg-[#9e3530] rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold whitespace-nowrap"
          >
            <Plus size={18} />
            Tambah Pengguna
          </Button>
          ...
          <Button
            variant="outline"
            className="gap-2 border-2 border-[#BE4139] bg-white rounded-xl hover:bg-gray-50 hover:border-[#9e3530] whitespace-nowrap"
          >
