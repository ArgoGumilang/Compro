...
const DeleteReturnModal: React.FC<DeleteReturnModalProps> = ({
  isOpen,
  data,
  onClose,
}) => {
  const handleDelete = () => {
    console.log("Deleting book return data:", data);
    onClose();
  };
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          <p className="text-gray-800 font-medium">
            Apakah Anda yakin ingin menghapus data pengembalian buku ini?
          </p>
