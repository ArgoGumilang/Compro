...
interface DetailPengembalianModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const ViewReturnModal: React.FC<DetailPengembalianModalProps> = ({
  isOpen,
  onClose,
  data,
}) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Detail Pengembalian">
